// 일회성: Gmail + Sheets 읽기용 refresh token 발급 (로컬에서 1번만 실행)
// 사용법:
//   1) npm i googleapis
...
//   ※ 데일리 매출 리포트(api/daily-report.js)가 구글시트를 읽으려면 spreadsheets.readonly
//     스코프가 반드시 포함돼야 함. (Gmail 전용 토큰이면 시트 읽기 403)
